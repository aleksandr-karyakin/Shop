...
CREATE TABLE orders(id int primary key auto_increment, user_id int not null, date date default current_date(), status varchar(255) default 'NEW', foreign key (user_id) references users(id));
